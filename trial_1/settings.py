"""
Django settings for trial_1 project.
...
SECRET_KEY = 'django-insecure-n#$mrx@9um8+zj@s58sa)77(i8)olvhp0-r!m3&2py=@ae8uge'
...
INSTALLED_APPS = [
    ...
    # 'django.contrib.sessions',    # not use this anymore
